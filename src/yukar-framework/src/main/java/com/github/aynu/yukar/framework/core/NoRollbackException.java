...
public class NoRollbackException extends EnterpriseException {
     ...
     */
    public NoRollbackException(final Throwable cause) {
        super(cause);
    }
    /**
     * コンストラクタ
     ...
     * @param cause 例外オブジェクト
     */
    public NoRollbackException(final String message, final Throwable cause) {
        super(message, cause);
    }
    /**
     * コンストラクタ
     ...
     */
    public NoRollbackException(final String key, final Object... values) {
        super(key, values);
    }
    /**
     * コンストラクタ
     ...
     */
    public NoRollbackException(final Map<String, Object[]> messageMap) {
        super(messageMap);
    }
}
// CHECKSTYLE:ON
